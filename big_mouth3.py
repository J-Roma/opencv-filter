...
def process_frame(frame, face_landmarks):
    # Face landmarks detection
    landmarks = face_landmarks.get_lips_landmarks(frame)
    ...
    if len(landmarks) > 1:
        ...
        draw_message(frame, "Face not detected")
        return frame
...
def main():
    ...
    while True:
        ...
        result_frame = process_frame(frame, face_landmarks)

        cv2.imshow("Camera Window", result_frame)
